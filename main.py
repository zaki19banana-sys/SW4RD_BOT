...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]SW4RD CHEAT [00FF00]!!
"""
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]SW4RD CHEAT    
[FFD700]✨ Name on instagram : [FFFFFF]zvvki.19❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> SW4RD CHEAT ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "SW4RD CHEAT ", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To sw4rdXbot"
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]SW4RD CHEAT 
...
async def MaiiiinE():
    Uid , Pw = '4296681472','830A9826EA3BD7539D503419DE0DE708C78E87C220F342E50DDAECB8EF9805AA'
    ...
    os.system('clear')
    print("Initializing SW4RD CHEAT  Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    os.system('clear')
    print(render('SW4RD CHEAT s', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 SW4RD CHEAT  BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using SW4RD CHEAT ")
    sys.exit(0)
